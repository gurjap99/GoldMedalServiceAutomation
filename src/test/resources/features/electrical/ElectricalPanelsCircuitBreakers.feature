Feature: Gold Medal Service Electrical Electrical Panels & Circuit Breakers page tests
...
#    Then I can verify Phone call popup
    ...
    Then it navigates to "https://test.goldmedalservice.com/electrical-services"
