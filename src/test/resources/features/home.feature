Feature: Gold Medal Service home page tests
  ...
  Scenario: Validate Header Sub Menu Order
    ...
    Then I should see new page with URL "https://test.goldmedalservice.com/learning-hub"
  ...
  Scenario: Validate visibility of static phone number in home page
    Given I navigate to "https://test.goldmedalservice.com" with javaScript turned off, then I visible phone numbers should be same as static phone number
...
#    Then I can close customer care modal
  ...
  Scenario: Verify footer Privacy Policy and ADA Notice links
    ...
    Then it navigates to "https://test.goldmedalservice.com/privacy-policy"
    When I click on ADA Notice Link
    Then it navigates to "https://test.goldmedalservice.com/ada-notice"
