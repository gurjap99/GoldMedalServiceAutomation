Feature: Gold Medal Service Heating & Cooling Ductless Mini-Splits Page tests
...
#    Then I can verify Phone call popup
    ...
    Then it navigates to "https://test.goldmedalservice.com/heating-and-cooling-services"
