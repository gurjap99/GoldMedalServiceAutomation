Feature: Gold Medal Service Plumbing Overview Page tests
  ...
  Scenario: Validate Water Heaters of Plumbing services CTA
    ...
    Then it navigates to "https://test.goldmedalservice.com/plumbing-services/water-heaters"
  ...
  Scenario: Validate Kitchen & Bathroom of Plumbing services CTA
    ...
    Then it navigates to "https://test.goldmedalservice.com/plumbing-services/kitchen-and-bathroom"
  ...
  Scenario: Validate Water Lines of Plumbing services CTA
    ...
    Then it navigates to "https://test.goldmedalservice.com/plumbing-services/water-lines"
  ...
  Scenario: Validate Drains & Sewer Lines of Plumbing services CTA
    ...
    Then it navigates to "https://test.goldmedalservice.com/plumbing-services/drains-and-sewer-lines"
  ...
  Scenario: Validate Gas Lines of Plumbing services CTA
    ...
    Then it navigates to "https://test.goldmedalservice.com/plumbing-services/gas-lines"
  ...
  Scenario: Validate Sump Pumps of Plumbing services CTA
    ...
    Then it navigates to "https://test.goldmedalservice.com/plumbing-services/sump-pumps"
  ...
  Scenario: Validate Well Pumps of Plumbing services CTA
    ...
    Then it navigates to "https://test.goldmedalservice.com/plumbing-services/well-pumps"
  ...
  Scenario: Validate Water Treatment of Plumbing services CTA
    ...
    Then it navigates to "https://test.goldmedalservice.com/plumbing-services/water-treatment"
  ...
  Scenario: Validate Image Call and Book Now buttons on Plumbing overview page
    ...
    When I Click on Plumbing
    When I click on Overview button in "Plumbing" header submenu
    When I click on Book Now button in Image on "Gold Medal Service plumbing" Page
    Then I should see Book Online Now Window and close it
    When I click on Phone Number in Image on "Gold Medal Service plumbing" Page
    Then I can verify Phone call popup