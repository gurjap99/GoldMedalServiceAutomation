...
public class Data {
    public static final String BASE_URL = "https://test.goldmedalservice.com/";
    ...
    public static final String WHY_HORIZON_URL = BASE_URL + "about-us/why-gold-medal";
    ...
    static {
        ...
        categoryServiceMap.put("About Us", new ArrayList<>(Arrays.asList(
                "Why Gold Medal", "Reviews", "Work With Us", "Contact Us", "In the Community", "Preferred Brands"
        )));
    }
}
