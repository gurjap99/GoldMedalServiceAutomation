Feature: Gold Medal Service About Us Why gold medal Page tests

  @Regression
  Scenario: Open About Us Why gold medal page and verify Book Now, Call buttons:
    Given I navigate to "https://test.goldmedalservice.com"
    When I Click on About Us
    When I click on "Why Gold Medal" button in category header submenu
