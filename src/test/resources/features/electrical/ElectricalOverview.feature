Feature: Gold Medal Service Electrical Overview Page tests
  ...
  Scenario: Validate Lighting & Ceiling Fans of Electrical services CTA
    ...
    Then it navigates to "https://test.goldmedalservice.com/electrical-services/lighting-and-ceiling-fans"
  ...
  Scenario: Validate Electrical Panels & Circuit Breakers of Electrical services CTA
    ...
    Then it navigates to "https://test.goldmedalservice.com/electrical-services/electrical-panels-and-circuit-breakers"
  ...
  Scenario: Validate Electrical Wiring of Electrical services CTA
    ...
    Then it navigates to "https://test.goldmedalservice.com/electrical-services/electrical-wiring"
  ...
  Scenario: Validate Electrical Remodeling of Electrical services CTA
    ...
    Then it navigates to "https://test.goldmedalservice.com/electrical-services/electrical-remodeling"
  ...
  Scenario: Validate Electric Vehicle Chargers of Electrical services CTA
    ...
    Then it navigates to "https://test.goldmedalservice.com/electrical-services/electric-vehicle-chargers"
  ...
  Scenario: Validate Whole-House Generators of Electrical services CTA
    ...
    Then it navigates to "https://test.goldmedalservice.com/electrical-services/whole-house-generators"
  ...
  Scenario: Validate Whole-House Surge Protectors of Electrical services CTA
    ...
    Then it navigates to "https://test.goldmedalservice.com/electrical-services/whole-house-surge-protectors"
  ...
  Scenario: Validate Image Call and Book Now buttons on Electrical overview page
    ...
    When I Click on Electrical
    When I click on Overview button in "Electrical" header submenu
    When I click on Book Now button in Image on "Gold Medal Service electrical" Page
    Then I should see Book Online Now Window and close it
    When I click on Phone Number in Image on "Gold Medal Service electrical" Page
    Then I can verify Phone call popup